...
const testimonials = [
  {
    ...
    review:
      "Adopting Mithu through Cuddly Paws was one of the best decisions I've made. As a busy professional, I appreciated how thorough the adoption process was - they matched me with a cat that fits perfectly with my work-from-home lifestyle. The follow-up care tips were incredibly helpful for a first-time pet owner like me.",
  ...
  },
  {
    ...
    review:
      "As a doctor with long shifts, I was hesitant about pet ownership until I found Cuddly Paws' senior cat adoption program. They matched me with 8-year-old Milo who prefers a calm environment. The team provided excellent resources about automatic feeders and litter boxes that make pet care manageable with my hospital schedule.",
  ...
  },
  {
    ...
    review:
      "I adopted Snowy during a particularly stressful period at work, and she's brought so much joy to my life. Cuddly Paws didn't just facilitate the adoption - they connected me with a community of pet owners in Uttara. We now have regular meetups at the park, and Snowy has made friends just like I have!",
...
const Reviews = () => {
  ...
  return (
    <div
      className="bg-white relative bg-[url(./assets/diamonds.png)] dark:bg-[url(./assets/flowers.png)] dark:bg-gray-900 text-black dark:text-gray-200 pt-8 pb-10 md:pt-14"
      ref={containerRef}
    >
